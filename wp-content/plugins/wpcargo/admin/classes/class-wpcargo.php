...
class WPCargo{
	...
	*/
	...
	public function barcode_url( $shipment_id, $barcode_size = '', $barcode_type = '', $orientation = '' ){
		...
		$src		= 'data:image/png;base64,'.base64_encode($generator->getBarcode( get_the_title( $shipment_id ), $generator::TYPE_CODE_128, $width, $height ));
		return apply_filters( 'wpcargo_barcode_url', $src, $shipment_id );
	}
	/*
	** Protected Functions
	*/
